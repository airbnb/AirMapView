...
public class MainActivity extends AppCompatActivity
  ...
  @Override public void onMapInitialized() {
    ...
    if (map.getMapInterface() instanceof LeafletWebViewMapFragment) {
      ...
      addMarker("Airbnb Beijing Office", airbnbLatLng, 1);
      addMarker("Tianan Men", new LatLng(39.908692, 116.397477), 2);
      ...
      addMarker("Dongzhi Men", new LatLng(39.941823, 116.426319), 3, image, 25, 41);
      map.animateCenterZoom(airbnbLatLng, 11);

      // Add Polylines
      LatLng[] latLngs = {
              new LatLng(39.918786, 116.459273),
              new LatLng(39.908692, 116.397477),
